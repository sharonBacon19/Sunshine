			...
			<ul>	<!-- SLIDE  -->
				...
				data-description="">
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 400; color: #ffffff; letter-spacing: 10px;font-family:Roboto Condensed;">¡TRAJES DE BAÑO!</div>
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Encuentra tu mejor bikini o bañador en SunShine.</div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-74" 
					data-transition="fade" 
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 400; color: #ffffff; letter-spacing: 10px;font-family:Roboto Condensed;">DISEÑOS ÚNICOS </div>
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Luce los diseños únicos de nuestra tienda cada verano.
					</div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-75" 
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 6; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Te llevamos hasta la puerta de tu casa los trajes de baño con la mejor calidad. 
 </div>
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 400; color: #ffffff; letter-spacing: 10px;font-family:Roboto Condensed;">CALIDAD </div>
