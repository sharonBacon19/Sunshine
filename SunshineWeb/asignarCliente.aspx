                            ...
                            <div class="col-md-6">
                                ...
                                <div class="media-body">
                                    <div class="user-profile-list">
                                        ...
                                        <asp:Label ID="lblNivelCliente" runat="server"></asp:Label>
                                        <br />
                                        <br />
                                ...
                                <div class="block">
                                    ...
                                    <br />
                                    <br />
                                    <asp:Button ID="btnAsignar" Text="Asinar Cupón" CssClass="btn btn-main btn-default" runat="server" OnClick="btnAsignar_Click" />
